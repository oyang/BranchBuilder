...
class CIDeployIndex:
	...
	deployInfo = DeployInfo().getDeployInfo()
        ...
        return render.cideploy(od_deploys, appconfig.site_url, upgradeStatus, appconfig.od_users, deployInfo, appconfig.od_version)
...
class CIDeployUpdate:
    def GET(self):
      ...
      return render.CIDeploy_detail(od_deploy, appconfig.site_url)
